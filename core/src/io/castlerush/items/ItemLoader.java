...
public class ItemLoader {
 ...
 // Defines every item in the game
    public static void loadItems() {
        ...
        //Weapons
        woodSword = new ItemWeapon("Holzschwert", 10, null, 100, "Level 1");
        stoneSword = new ItemWeapon("Steinschwert", 15, null, 500, "Level 2");
        ironSword = new ItemWeapon("Eisenschwert", 20, null, 1000, "Level 3");
        slingShot = new ItemWeapon("Steinschleuder", 5, null, 100, "Level 1");
        bow = new ItemWeapon("Bogen", 15, null, 500, "Level 2");
